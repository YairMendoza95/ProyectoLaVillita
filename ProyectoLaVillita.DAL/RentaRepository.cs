...
namespace ProyectoLaVillita.DAL
{
    public class RentaRepository : IRepositorioGenerico<RentaDTO>
    {
        ...
        public List<RentaDTO> Elementos
        {
            get
            {
                try
        ...
        public bool Insertar(RentaDTO entidad)
        {
            ...
            {
                conexion.Open();
                da.InsertCommand = new MySqlCommand("Insert into renta (iidCliente, total, notas) values (" + entidad.idCliente + ", " + entidad.total + ", '" + entidad.notas + "')", conexion);
