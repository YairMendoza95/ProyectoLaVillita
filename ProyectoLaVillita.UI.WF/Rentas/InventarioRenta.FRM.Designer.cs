namespace ProyectoLaVillita.UI.WF.Rentas
{
    partial class InventarioRenta
    {
        ...
        private void InitializeComponent()
        {
			...
			// 
			this.inventarioToolStripMenuItem1.Enabled = false;
			...
			this.btnSalir.Location = new System.Drawing.Point(285, 186);
			...
			this.groupBox3.Controls.Add(this.txtMesas);
			...
			this.Load += new System.EventHandler(this.InventarioRenta_Load);
