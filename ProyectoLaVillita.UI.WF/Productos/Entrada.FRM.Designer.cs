namespace ProyectoLaVillita.UI.WF.Productos
{
    partial class Entrada
    {
        ...
        private void InitializeComponent()
        {
			...
			// 
			this.entradasToolStripMenuItem.Enabled = false;
			...
			this.cambiarDeUsuariioToolStripMenuItem.Click += new System.EventHandler(this.cambiarDeUsuariioToolStripMenuItem_Click_1);
			// 
